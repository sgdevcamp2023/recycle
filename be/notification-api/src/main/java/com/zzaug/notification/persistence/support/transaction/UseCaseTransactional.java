package com.zzaug.notification.persistence.support.transaction;

import com.zzaug.notification.config.NotificationJpaDataSourceConfig;
...
public @interface UseCaseTransactional {
	...
	String value() default NotificationJpaDataSourceConfig.TRANSACTION_MANAGER_NAME;

	@AliasFor(annotation = Transactional.class, attribute = "transactionManager")
	String transactionManager() default NotificationJpaDataSourceConfig.TRANSACTION_MANAGER_NAME;
