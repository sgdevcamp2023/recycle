...
public class JpaDataSourceConfig {
	...
	private static final String ENTITY_PROPERTY_PREFIX = ReviewAppConfig.PROPERTY_PREFIX + ".entity";

	public static final String ENTITY_BEAN_NAME_PREFIX = ReviewAppConfig.BEAN_NAME_PREFIX + "Entity";
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		return builder
				...
				.packages(ReviewAppConfig.BASE_PACKAGE)
				.build();
	}
